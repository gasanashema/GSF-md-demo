...
//Primary use:	Oral Admin - Responsive Admin Template
...
// Dynamic active menu
    var path = window.location.pathname.split("https://oral-admin-dashboard-template.multipurposethemes.com/").pop();
