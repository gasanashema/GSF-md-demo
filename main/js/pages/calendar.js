        ...
        (e.prototype.init = function () {
            ...
            new FullCalendar.Draggable(document.getElementById("external-events"), {
                ...
                eventData: function (e) {
                    return { title: e.innerText, className: $(e).data("class") };
                },
            });
            var t = [
                    { title: "Lunch", start: new Date($.now() + 178e6), end: new Date($.now() + 138e6), className: "bg-warning" },
                    { title: "Do Homework", start: new Date($.now() + 168e6), className: "bg-primary" },
                    { title: "SLEEP TIGHT", start: new Date($.now() + 338e6), end: new Date($.now() + 338e6), className: "bg-danger" },
                    {
                        title: 'All Day Event',
                        start: moment(new Date(), 'YYYY-MM-DD').add(-18, 'days').format('YYYY-MM-DD') + 'T05:10:00.000Z',
                        className: "bg-primary"
                    },
                    {
                        title: 'Long Event',
                        start: moment(new Date(), 'YYYY-MM-DD').add(-16, 'days').format('YYYY-MM-DD') + 'T05:20:00.000Z',
                        end: moment(new Date(), 'YYYY-MM-DD').add(-13, 'days').format('YYYY-MM-DD') + 'T05:20:00.000Z',
                        className: "bg-info"
                    },
                    {
                        groupId: '999',
                    ...
                    },
                    {
                        groupId: '999',
                        title: 'Repeating Event',
                        start: moment(new Date(), 'YYYY-MM-DD').add(-10, 'days').format('YYYY-MM-DD') + 'T05:50:00.000Z',
                         className: "bg-black"
                    },
                    {
                        title: 'Birthday Party',
                        start: moment(new Date(), 'YYYY-MM-DD').add(-8, 'days').format('YYYY-MM-DD') + 'T07:90:00.000Z',
                         className: "bg-danger"
                    },
                    {
                        title: 'Meeting',
            ...
            (a.$calendarObj = new FullCalendar.Calendar(a.$calendar[0], {
                ...
                a.$formEvent.on("submit", function (e) {
                    ...
                    n.checkValidity()
                        ? (a.$selectedEvent
                              ? (a.$selectedEvent.setProp("title", $("#event-title").val()), a.$selectedEvent.setProp("classNames", [$("#event-category").val()]))
                              : ((t = { title: $("#event-title").val(), start: a.$newEventData.date, allDay: a.$newEventData.allDay, className: $("#event-category").val() }), a.$calendarObj.addEvent(t)),
                          a.$modal.hide())
